...
ebird_data2 <- read_delim(
  "eBird data/ebd_US-CA-087_pifshe_201501_202511_smp_relOct-2025/ebd_US-CA-087_pifshe_201501_202511_smp_relOct-2025.txt",
  delim = "\t",
  show_col_types = FALSE
)
...
ebird_data3 <- read_delim(
  "eBird data/ebd_US-CA-087_sooshe_201501_202511_smp_relOct-2025/ebd_US-CA-087_sooshe_201501_202511_smp_relOct-2025.txt",
  delim = "\t",
  show_col_types = FALSE
)

ebird_data3 <- ebird_data3 %>%
  janitor::clean_names()
